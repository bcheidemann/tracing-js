# Contributing to @bcheidemann/tracing <!-- omit in toc -->
...
[@bcheidemann/tracing Code of Conduct](https://github.com/bcheidemann/tracing-js/blob/master/CODE_OF_CONDUCT.md).
...
> [Documentation](https://jsr.io/@bcheidemann/tracing).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/bcheidemann/tracing-js/issues) that might help you.
...
- Open an [Issue](https://github.com/bcheidemann/tracing-js/issues/new).
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://jsr.io/@bcheidemann/tracing). If you are looking for
  support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the
  same issue you are having, check if there is not already a bug report existing
  for your bug or error in the
  [bug tracker](https://github.com/bcheidemann/tracing-js/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/bcheidemann/tracing-js/issues/new). (Since
...
@bcheidemann/tracing, **including completely new features and minor improvements
...
- Make sure that you are using the latest version.
- Read the [documentation](https://jsr.io/@bcheidemann/tracing) carefully and
  find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/bcheidemann/tracing-js/issues) to see if
...
[GitHub issues](https://github.com/bcheidemann/tracing-js/issues).
...
- **Explain why this enhancement would be useful** to most @bcheidemann/tracing
...
- Run the checks with `deno task checks`
